...
interface PlannerGridProps {
  ...
  onSessionSelect: (bookingId: string, event: React.MouseEvent) => void;
...
const PlannerGrid: React.FC<PlannerGridProps> = ({ selectedDate, bookings, blockedSlots, onEditSession, onSessionSelect, selectedBookingIds, potentialConflicts }) => {
      ...
      <div className="relative border-l border-gray-200">
        ...
        {courtBookings.map(booking => (
          <ResizableSessionCard 
            ...
            onSelect={(e) => onSessionSelect(booking.id, e)}
            isSelected={selectedBookingIds.has(booking.id)}
            onDoubleClick={() => onEditSession(booking)}
          />
        ))}
