...
const NavLink: React.FC<{
  ...
  const classes = `
    w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium cursor-pointer transition-colors
    ${isActive
  ...
  // Using a button for SPA view changes is more accessible than an anchor tag.
  return (
