...
const BookingModal: React.FC<BookingModalProps> = ({ court, time, date, onConfirm, onClose }) => {
    ...
    return (
        ...
        >
            ...
            >
                <h2 id="booking-modal-title" className="text-2xl font-bold text-slate-800">Confirm Your Booking</h2>
                
                <div className="mt-6 space-y-4 text-slate-700">
                    <div className="flex items-center p-3 bg-slate-100 rounded-lg">
                        <span className="font-semibold w-20">Court:</span>
